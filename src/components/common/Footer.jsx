...
const Footer = () => {
    return (
        <div className="p-8 prose dark:prose-invert font-poppins">
            <footer className="bg-card text-card-foreground py-4 border-t border-border">
                <div className="container mx-auto flex flex-col md:flex-row justify-between items-center">
                    <div className="text-lg font-semibold">GetAway</div>
                    <div className="flex space-x-4 my-2 md:my-0">
                        <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="bg-secondary text-secondary-foreground p-2 rounded-full">
                        ...
                        <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="bg-secondary text-secondary-foreground p-2 rounded-full">
                            <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="bg-secondary text-secondary-foreground p-2 rounded-full">
                            <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="text-sm text-muted-foreground">Copyright © 2024 GetAway Pvt Ltd. All rights reserved.</div>
                </div>
            </footer>
        </div>
    )
