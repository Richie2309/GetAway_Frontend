...
const Signup = () => {
    ...
    const onSubmit = async (data) => {
        try {
            ...
            const response = await API.get(userRoutes.checkUserExists(email));
            ...
            await API.post(userRoutes.register, { fullName, email, password });

            // Set isOtpSend to true to render SignupOtp component
            setIsOtpSend(true);
        } catch (err) {
            console.log(err);
        }
                    ...
                    <div className="bg-white rounded-lg shadow-lg overflow-hidden flex w-3/4 max-w-4xl">
                        ...
                        <div className="w-1/2 p-8">
                            ...
                            <p className="mt-4 text-center text-sm text-zinc-600">
                                Already have an account?<Link to={'/signin'} ><span className="text-red-600"> Login</span></Link>
                            </p>
                        </div>
                    </div>
                </div>
